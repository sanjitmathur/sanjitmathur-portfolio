...
const translations: Record<Lang, {
  ...
  en: {
    ...
    projects: {
      ...
      fraud: { title: "Distributed Fraud Detection", cat: "ML · Security", desc: "Built an end-to-end fraud detection system analyzing credit card transactions using unsupervised anomaly detection models (Isolation Forest, LOF, One-Class SVM, Autoencoder). Engineered domain features and trained models using normal-only data pipelines with automated threshold optimization. Developed an interactive Streamlit dashboard with SHAP explainability for real-time anomaly investigation." },
      forecast: { title: "Multi-Domain Demand Forecaster", cat: "ML · Forecasting", desc: "Built demand forecasting engine using XGBoost + LightGBM stacking ensemble with Ridge meta-learner. Implemented Quantile Regression for 10th/90th percentile confidence intervals and engineered cyclical sine/cosine temporal encodings with domain-specific rolling statistics. Deployed via RESTful FastAPI service and interactive Streamlit dashboard." },
      examforge: { title: "ExamForge", cat: "AI · EdTech", desc: "Built a full-stack AI-powered exam generation platform using LLM APIs for dynamic multi-format question creation. Designed interactive workflows allowing students to generate, attempt, and review customized assessments." },
    ...
    skills: {
      ...
      domains: {
        aiml: { area: "AI / ML", detail: "LLM APIs, OpenCV, scikit-learn, Stacking Ensembles, Quantile Regression" },
        fullstack: { area: "Full-Stack", detail: "React, Next.js, Node.js, Express.js, FastAPI, Pydantic" },
        infra: { area: "Infrastructure", detail: "Docker, Kubernetes, PostgreSQL, Streamlit, Plotly, Joblib" },
        langs: { area: "Languages", detail: "Python, TypeScript, C, SQL, MATLAB" },
      },
    },
    experience: {
  ...
  hi: {
    ...
    projects: {
      ...
      fraud: { title: "Distributed Fraud Detection", cat: "ML · सुरक्षा", desc: "असंरचित विसंगति पहचान मॉडल (Isolation Forest, LOF, One-Class SVM, Autoencoder) का उपयोग करके क्रेडिट कार्ड लेनदेन का विश्लेषण करने वाली एंड-टू-एंड धोखाधड़ी पहचान प्रणाली बनाई। डोमेन फीचर्स इंजीनियर किए और स्वचालित थ्रेशोल्ड ऑप्टिमाइज़ेशन के साथ सामान्य-डेटा पाइपलाइन से मॉडल प्रशिक्षित किए। रियल-टाइम विसंगति जाँच के लिए SHAP व्याख्यात्मकता के साथ इंटरैक्टिव Streamlit डैशबोर्ड विकसित किया।" },
      ...
      examforge: { title: "ExamForge", cat: "AI · एडटेक", desc: "डायनामिक मल्टी-फॉर्मेट प्रश्न निर्माण के लिए LLM APIs का उपयोग करके फुल-स्टैक AI-संचालित परीक्षा निर्माण प्लेटफ़ॉर्म बनाया। छात्रों को कस्टमाइज़्ड मूल्यांकन बनाने, प्रयास करने और समीक्षा करने की अनुमति देने वाले इंटरैक्टिव वर्कफ़्लो डिज़ाइन किए।" },
    ...
    skills: {
      ...
      domains: {
        aiml: { area: "AI / ML", detail: "LLM APIs, OpenCV, scikit-learn, Stacking Ensembles, Quantile Regression" },
        fullstack: { area: "फुल-स्टैक", detail: "React, Next.js, Node.js, Express.js, FastAPI, Pydantic" },
        infra: { area: "इन्फ्रास्ट्रक्चर", detail: "Docker, Kubernetes, PostgreSQL, Streamlit, Plotly, Joblib" },
        langs: { area: "भाषाएँ", detail: "Python, TypeScript, C, SQL, MATLAB" },
      },
    },
    experience: {
  ...
  ar: {
    ...
    projects: {
      ...
      fraud: { title: "Distributed Fraud Detection", cat: "ML · أمان", desc: "بنيت نظام كشف احتيال شامل يحلل معاملات بطاقات الائتمان باستخدام نماذج كشف الشذوذ غير الخاضعة للإشراف (Isolation Forest, LOF, One-Class SVM, Autoencoder). هندست ميزات المجال ودربت النماذج باستخدام خطوط أنابيب البيانات العادية مع تحسين العتبة التلقائي. طورت لوحة معلومات Streamlit تفاعلية مع قابلية تفسير SHAP للتحقيق في الشذوذ في الوقت الفعلي." },
      ...
      examforge: { title: "ExamForge", cat: "AI · تعليم", desc: "بنيت منصة توليد امتحانات مدعومة بالذكاء الاصطناعي باستخدام واجهات LLM لإنشاء أسئلة ديناميكية متعددة الصيغ. صممت سير عمل تفاعلية تتيح للطلاب إنشاء ومحاولة ومراجعة التقييمات المخصصة." },
    ...
    skills: {
      ...
      domains: {
        aiml: { area: "AI / ML", detail: "LLM APIs, OpenCV, scikit-learn, Stacking Ensembles, Quantile Regression" },
        fullstack: { area: "فول ستاك", detail: "React, Next.js, Node.js, Express.js, FastAPI, Pydantic" },
        infra: { area: "البنية التحتية", detail: "Docker, Kubernetes, PostgreSQL, Streamlit, Plotly, Joblib" },
        langs: { area: "اللغات", detail: "Python, TypeScript, C, SQL, MATLAB" },
      },
    },
    experience: {
  ...
  de: {
    ...
    projects: {
      ...
      fraud: { title: "Distributed Fraud Detection", cat: "ML · Sicherheit", desc: "Ein End-to-End-Betrugserkennungssystem zur Analyse von Kreditkartentransaktionen mit unüberwachten Anomalieerkennungsmodellen (Isolation Forest, LOF, One-Class SVM, Autoencoder) entwickelt. Domänenmerkmale engineert und Modelle mit Nur-Normal-Daten-Pipelines mit automatisierter Schwellenwertoptimierung trainiert. Ein interaktives Streamlit-Dashboard mit SHAP-Erklärbarkeit für Echtzeit-Anomalieuntersuchung entwickelt." },
      ...
      examforge: { title: "ExamForge", cat: "KI · EdTech", desc: "Eine Full-Stack KI-gestützte Prüfungsgenerierungsplattform mit LLM-APIs für dynamische Multi-Format-Fragenerstellung entwickelt. Interaktive Workflows entworfen, die Studenten ermöglichen, maßgeschneiderte Prüfungen zu erstellen, zu bearbeiten und zu überprüfen." },
    ...
    skills: {
      ...
      domains: {
        aiml: { area: "KI / ML", detail: "LLM APIs, OpenCV, scikit-learn, Stacking Ensembles, Quantile Regression" },
        fullstack: { area: "Full-Stack", detail: "React, Next.js, Node.js, Express.js, FastAPI, Pydantic" },
        infra: { area: "Infrastruktur", detail: "Docker, Kubernetes, PostgreSQL, Streamlit, Plotly, Joblib" },
        langs: { area: "Sprachen", detail: "Python, TypeScript, C, SQL, MATLAB" },
      },
    },
    experience: {
  ...
  es: {
    ...
    projects: {
      ...
      fraud: { title: "Distributed Fraud Detection", cat: "ML · Seguridad", desc: "Construí un sistema de detección de fraude de extremo a extremo que analiza transacciones de tarjetas de crédito usando modelos de detección de anomalías no supervisados (Isolation Forest, LOF, One-Class SVM, Autoencoder). Diseñé características de dominio y entrené modelos con pipelines de datos normales con optimización automática de umbrales. Desarrollé un panel interactivo en Streamlit con explicabilidad SHAP para investigación de anomalías en tiempo real." },
      ...
      examforge: { title: "ExamForge", cat: "IA · EdTech", desc: "Construí una plataforma de generación de exámenes impulsada por IA usando APIs LLM para creación dinámica de preguntas multiformato. Diseñé flujos de trabajo interactivos que permiten a los estudiantes generar, intentar y revisar evaluaciones personalizadas." },
    ...
    skills: {
      ...
      domains: {
        aiml: { area: "IA / ML", detail: "LLM APIs, OpenCV, scikit-learn, Stacking Ensembles, Quantile Regression" },
        fullstack: { area: "Full-Stack", detail: "React, Next.js, Node.js, Express.js, FastAPI, Pydantic" },
        infra: { area: "Infraestructura", detail: "Docker, Kubernetes, PostgreSQL, Streamlit, Plotly, Joblib" },
        langs: { area: "Lenguajes", detail: "Python, TypeScript, C, SQL, MATLAB" },
      },
    },
    experience: {
